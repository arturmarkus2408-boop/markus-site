...
- По ГК, КоАО, Закону об ООО, НСБУ и постановлениям справочника пока нет.
  По ним объясняй суть, но номера статей подавай как требующие проверки.
...
function findArticles(book, text) {
  ...
  const hints = {
    ...
    НК: /\bнк\b|налог|ндс|ндфл|ққс|жшдс|акциз|прибыл|оборот|вычет|льгот|деклараци|счет-фактур|счёт-фактур|камеральн|аудит|пеня|санкци|соли[кқ]/i,
  };
